...
export default function Interviewing() {
    let [interviewingJobData, setInterviewingJobData] = useState([])
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setInterviewingJobData(res.data)
        }
        fetchData()
    }, [])

    let filterData = interviewingJobData.filter(
        (ele) =>
    ...
    return (
        <div className="interview">
            ...
            <table>
                ...
                {/* <tbody>
                    <tr><td className="job_code_gj_i">JPC-2</td>
                        <td>Production Manager</td>
                        <td>Banglore</td>
                        <td>08 Jan 2022</td>
                        <td>09 Jan 2022</td>
                        <td className="job_status_gj_i">Interviewing</td>
                    </tr>
                </tbody>
                <tbody>
                    <tr><td className="job_code_gj_i">JPC-2</td>
